...
const  vis = d3.select("#easy-as-pie-chart").selectAll('svg')
                .data([1])
                .join("svg")
                .attr("width", w + 150)
                .attr("height", h);

const svg=vis.selectAll('g#chart-group')
    .data([1])
    .join('g')
    .attr('id','chart-group')
    ...
    progressBar.key('first')
                  ...
                  .negativeColor('red')
                  .positiveColor('green')
                  .on('click',() => console.log('first  click '))
                  .draw()
                  


    // svg.append('rect').attr('x',0).attr('y',2).attr('width',10).attr('height',120).attr('style',"fill:#6B3D83;" )

    
                  

    // const progressBarThree = new ProgressBar();
    // progressBarThree.draw(svg,110,2,100,25,15);



    // const progressBarFour = new ProgressBar();
    // progressBarFour.draw(svg,130,2,100,25,55);
    // const progressBarFour1 = new ProgressBar();
    // progressBarFour1.draw(svg,230,2,100,10,65);

    // progressBarFour1.draw(svg,330,2,100,1,105);


    // progressBarFour1.draw(svg,0,2,120,50,5);

    // x,y,cylinderHeight,posBar,negative